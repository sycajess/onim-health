...
export const MODULES: ModuleConfig[] = [
  ...
  { id: 'records', path: '/records', label: 'Medical Records', icon: '📋', section: 'clinical', roles: ['admin', 'doctor', 'nurse', 'nutritionist', 'pharmacist'] },
  { id: 'prescriptions', path: '/prescriptions', label: 'Prescriptions', icon: '💊', section: 'clinical', roles: ['admin', 'doctor', 'pharmacist', 'nurse'] },
  { id: 'labs', path: '/labs', label: 'Lab Results', icon: '🧪', section: 'clinical', roles: ['admin', 'doctor', 'nurse', 'nutritionist', 'lab_partner', 'pharmacist'] },
